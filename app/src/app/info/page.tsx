...
export default function InfoPage() {
    const [infos, setInfos] = useState(MOCK_INFOS);
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <Button variant="gold" size="sm" className="shadow-sm" onClick={() => setShowForm(true)}>
            ...
            <FAB onClick={() => setShowForm(true)} label="Add Information" />
        </div>
    );
}
